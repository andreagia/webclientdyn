...
import org.cirmmp.webclientdyn.rfm.error.ClientErrorMessage;
import org.cirmmp.webclientdyn.rfm.error.FMInitializationException;
import org.cirmmp.webclientdyn.rfm.error.FileManagerException;
import org.cirmmp.webclientdyn.rfm.model.FileAttributes;
import org.cirmmp.webclientdyn.rfm.model.FileData;
import org.cirmmp.webclientdyn.rfm.model.FileType;
...
public class LocalFileManager extends AbstractFileManager {
    ...
    private ArrayList<FileData>  uploadFiles(HttpServletRequest request, String targetDirectory) throws FileManagerException {
        ...
        try {
            logger.info("provo ad uploadare il file");
            logger.info(Boolean.toString(isMultipart));
            logger.info("----------");
